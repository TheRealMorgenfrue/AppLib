...
# nuitka-project: --product-name=Pixiv Manager
# nuitka-project: --product-version=1.8.26
...
if __name__ == "__main__":
    ...
    try:
        ...
        with open(Path(crashDir, f"crash {datetime.now().strftime("%Y-%m-%d")}.txt"), "a", encoding="utf-8") as file:
            file.write(f"{header}")
