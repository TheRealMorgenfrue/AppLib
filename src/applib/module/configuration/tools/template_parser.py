...
from typing import Any, Hashable, Self, override
...
class TemplateParserGUI(TemplateParser):
    _instance = None
    _logger = None
    ...
    def _parse_validation(
        ...
        # TODO: Make possible to override how values are found (e.g. what values are considered for min value)
